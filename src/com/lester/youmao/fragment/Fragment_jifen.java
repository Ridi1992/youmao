...
import com.lester.youmao.jifen.JifenRuleActivity;
...
public class Fragment_jifen extends Fragment implements OnClickListener {
...
//		http2.GoodsDesc(GoodsDetailActivity.this, getIntent().getStringExtra("goods_id"));
	...
	private void initViews(View v) {
		...
		mRule = (LinearLayout) v.findViewById(R.id.jifen_rule);
		mRule.setOnClickListener(this);
		mDetail = (LinearLayout) v.findViewById(R.id.jifen_detail);
	...
	public void onClick(View v) {
		...
		case R.id.jifen_rule:
			startActivity(new Intent(getActivity(), JifenRuleActivity.class));
			break;
		case R.id.jifen_detail:
			if (mUserInfo.GetUserInfo(getActivity())!= null) {
				Intent intent = new Intent();
