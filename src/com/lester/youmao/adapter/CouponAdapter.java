...
public class CouponAdapter extends BaseAdapter{
	...
	public CouponAdapter(CouponsListActivity c ,ArrayList<Coupon> list ){
		mList = list;
		this.c= c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.mLingQu.setOnClickListener(new receiveCoupon(position));
	...
	class receiveCoupon implements OnClickListener{
		private int i;
		public receiveCoupon(int position) {
			this.i = position;
		}
		@Override
