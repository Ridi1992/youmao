...
public class CheckGoodsAdapter extends BaseAdapter{
	...
	public CheckGoodsAdapter(Context c ,ArrayList<OrderList> list,int flow_type){
		mList = list;
		this.c = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		case 0:
			...
			break;
		case 4:
			Texttool.setText(viewHolder.CheckgoodsPrice, "总积分 ： "+orderList.getExchange_integral()+"");
			break;
		}
		String attr = "";
